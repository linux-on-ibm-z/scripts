...
"rhel-9.0" | "rhel-9.1")
    ...
    echo "name = MariaDB-10.11.3" | sudo tee -a /etc/yum.repos.d/MariaDB.repo
    echo "baseurl=http://mirror.mariadb.org/mariadb-10.11.3/yum/rhel9-s390x" | sudo tee -a /etc/yum.repos.d/MariaDB.repo
