...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Keystone/27.0.0/build_keystone.sh
...
CONF_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Keystone/27.0.0/conf"
...
"rhel-8.10" | "rhel-9.4" | "rhel-9.5")
    ...
    sudo pip3 install bcrypt==4.0.1 keystone==27.0.0 python-openstackclient mysqlclient
...
"sles-15.6")
    ...
    sudo pip3 install cryptography==41.0.7 bcrypt==4.0.1 keystone==27.0.0 python-openstackclient mysqlclient mod-wsgi uwsgi
    configureAndInstall | tee -a "$LOG_FILE"
    ;;
...
"ubuntu-22.04" | "ubuntu-24.04" | "ubuntu-24.10")
    ...
    sudo pip3 install $PIP_OPTIONS bcrypt==4.0.1 keystone==27.0.0 python-openstackclient
    configureAndInstall | tee -a "$LOG_FILE"
    ;;
