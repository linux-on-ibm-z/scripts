...
#
# Instructions:
# Download build script: curl -sSLO https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Consul/1.10.1/build_consul.sh
...
function configureAndInstall() {
    ...
    sed -i 's/"sles-12.5" | "sles-15.2")/"sles-12.5" | "sles-15.2" | "sles-15.3")/g' build_go.sh
    bash build_go.sh
    go version
