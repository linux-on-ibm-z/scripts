...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Consul/1.5.3/build_consul.sh
...
function configureAndInstall() {
    ...
    #Download Go
    wget $GO_INSTALL_URL && bash build_go.sh -y -v 1.12.1 
    go version
    ...
    sudo chown -R "$USER" "$GOPATH" "$GOROOT"
