...
#
# Instructions:
# Download build script: curl -sSLO https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Consul/1.9.3/build_consul.sh
...
function configureAndInstall() {
    ...
    cd ${GOPATH}
    wget "https://golang.org/dl/go${GO_PACKAGE_VERSION}.linux-s390x.tar.gz"
    chmod ugo+r "go${GO_PACKAGE_VERSION}.linux-s390x.tar.gz"
    sudo tar -C /usr/local -xvzf "go${GO_PACKAGE_VERSION}.linux-s390x.tar.gz"
