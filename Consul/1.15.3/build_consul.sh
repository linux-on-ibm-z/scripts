...
#
# Instructions:
# Download build script: curl -sSLO https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Consul/1.15.3/build_consul.sh
...
function cleanup() {
    # Remove artifacts
    rm -rf "$SOURCE_ROOT/go1.20.5.linux-s390x.tar.gz"
...
function configureAndInstall() {
    ...
    tar -xzf go1.20.5.linux-s390x.tar.gz
