...
#
# Instructions:
# Download build script: curl -sSLO https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Consul/1.14.3/build_consul.sh
...
function cleanup() {
    # Remove artifacts
    rm -rf "$SOURCE_ROOT/go1.19.4.linux-s390x.tar.gz"
...
function configureAndInstall() {
    ...
    cd ${GOPATH}
    wget https://go.dev/dl/go1.19.4.linux-s390x.tar.gz
    tar -xzf go1.19.4.linux-s390x.tar.gz
