...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/NGINX/build_nginx.sh
...
function printHelp() {
    echo
    echo "Usage: "
    echo "bash build_nginx.sh  [-d debug] [-v package-version] [-y install-without-confirmation]"
