...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/NGINX/1.22.0/build_nginx.sh
...
case "$DISTRO" in
"ubuntu-18.04" | "ubuntu-21.10" | "ubuntu-22.04")
