...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Grafana/7.4.3/build_grafana.sh
...
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Grafana/7.4.3/patch/datasource.test.ts.patch"

GO_VERSION="1.16.2"
NODE_JS_VERSION="14.16.0"
