...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Grafana/6.7.1/build_grafana.sh
...
GRAFANA_TESTS_PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Grafana/6.7.1/patch/ArrowDataFrame.test.ts.patch"
...
function configureAndInstall() {
	...
	if [[ "$DISTRO" == "rhel-7.5" ]] || [[ "$DISTRO" == "rhel-7.6" ]] || [[ "$DISTRO" == "rhel-7.7" ]]; then
		  sudo yum install -y devtoolset-7 devtoolset-7-libatomic-devel.s390x
