...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Grafana/11.6.0/build_grafana.sh
...
function configureAndInstall() {
	...
	git clone --depth=1 --single-branch -b v"${PACKAGE_VERSION}" git@github.com:grafana/grafana.git
	cd grafana
	go mod download
	make build-go
