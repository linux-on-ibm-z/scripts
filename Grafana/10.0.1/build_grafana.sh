...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Grafana/10.0.1/build_grafana.sh
...
CURDIR="$(pwd)"
export PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Grafana/10.0.1/patch"


GO_VERSION="1.20.5"
NODE_JS_VERSION="18.16.1"
