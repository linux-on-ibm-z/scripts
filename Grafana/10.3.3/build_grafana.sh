...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Grafana/10.3.3/build_grafana.sh
...
function configureAndInstall() {
	...
	git clone --depth 1 -b v"${PACKAGE_VERSION}" https://github.com/grafana/grafana.git
	cd grafana
