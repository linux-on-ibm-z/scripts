...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/XMLSec/1.3.1/build_xmlsec.sh
# Execute build script: bash build_xmlsec.sh    (provide -h for help)

set -e -o pipefail

PACKAGE_NAME="xmlsec"
PACKAGE_VERSION="xmlsec_1_3_1"
...
function configureAndInstall() {
    ...
    if [[ "$DISTRO" == "ubuntu-20.04" || "$DISTRO" == "ubuntu-22.04" || "$DISTRO" == "ubuntu-23.04" ]]; then
        ./autogen.sh 
    else
