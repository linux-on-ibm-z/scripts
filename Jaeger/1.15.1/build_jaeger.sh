...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Jaeger/1.15.1/build_jaeger.sh
...
CONF_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Jaeger/1.15.1/patch"
...
function configureAndInstall() {
  ...
  #Clone Jaeger source and get Jaeger modules
	...
	sudo wget -O "status_linux.go.diff"  $CONF_URL/status_linux.go.diff
