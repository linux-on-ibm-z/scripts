...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Terraform/0.13.4/build_terraform.sh
...
function installGo()
{
  ...
  export GO_INSTALL_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Go/1.15/build_go.sh"
  wget -O build_go.sh $GO_INSTALL_URL
  bash build_go.sh -v 1.14.7
...
function configureAndInstall()
{
  ...
  printf -- 'Downloading Terraform repository \n'
