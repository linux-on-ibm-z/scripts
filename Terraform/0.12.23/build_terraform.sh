...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Terraform/0.12.23/build_terraform.sh
...
function installGo()
{
  ...
  cd "${GOPATH}"
  wget "https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Go/1.13.5/build_go.sh"
  bash build_go.sh -y -v 1.12.9
