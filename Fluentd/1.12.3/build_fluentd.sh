...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Fluentd/1.12.3/build_fluentd.sh
...
RUBY_INSTALL_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Ruby/3.0.1/build_ruby.sh"
...
function configureAndInstall() {
    ...
    if [[ "${ID}" == "ubuntu" ]]; then
        ...
        sudo gem install webrick async
    else
        printf -- "Install gems \n"
        #Download fluentd
