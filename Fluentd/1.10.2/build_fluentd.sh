...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Fluentd/1.10.2/build_fluentd.sh
...
"ubuntu-16.04" | "ubuntu-18.04" | "ubuntu-19.10")
    ...
    sudo DEBIAN_FRONTEND=noninteractive apt-get update
        sudo DEBIAN_FRONTEND=noninteractive apt-get install -y gcc make wget zlib1g-dev |& tee -a "$LOG_FILE"
    else
        sudo apt-get update
