...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Fluentd/1.16.0/build_fluentd.sh
...
function gettingStarted() {
    ...
    printf -- "sed -i 's/<secondary>/<secondary>\\\n@type secondary_file\\\ndirectory <SOURCE_ROOT>/g' conf/fluent.conf \n\n"    
