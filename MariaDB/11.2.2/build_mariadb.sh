...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/MariaDB/11.2.2/build_mariadb.sh
...
function configureAndInstall() {
    ...
    cd "$CURDIR"
     if [[ "${DISTRO}" == rhel-7* ]]; then
        ...
        cd $CURDIR
        wget -q https://cmake.org/files/v3.7/cmake-3.7.2.tar.gz
