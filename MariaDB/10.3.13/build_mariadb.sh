...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/MariaDB/10.3.13/build_mariadb.sh
# Execute build script: bash build_mariadb.sh    (provide -h for help)

set -e -o pipefail

PACKAGE_NAME="mariadb"
PACKAGE_VERSION="10.3.13"
CURDIR="$(pwd)"
BUILD_DIR="/usr/local"
REPO_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/MariaDB/patch"
...
"ubuntu-19.04")
    ...
    printf -- "Installation Successful.. \n Binary Existed for ubuntu-19.04 \n\n" >> "$LOG_FILE";
