...
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/V8JavaScript/9.6/build_v8.sh
# Execute build script: bash build_v8.sh    (provide -h for help)


set -e -o pipefail
PACKAGE_NAME="v8"
PACKAGE_VERSION="9.6.180.20"
CURDIR="$(pwd)"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/V8JavaScript/9.6/patch"
