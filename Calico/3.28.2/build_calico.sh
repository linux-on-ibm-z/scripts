...
#Description:   The script builds Calico version v3.28.2 on Linux on IBM Z for RHEL (8.8, 8.10, 9.2, 9.4), Ubuntu (20.04, 22.04, 24.04) and SLES (15 SP5, 15 SP6).
...
#
#Download build script :   wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Calico/3.28.2/build_calico.sh
...
PACKAGE_NAME="calico"
PACKAGE_VERSION="v3.28.2"
ETCD_VERSION="v3.5.6"
GOLANG_VERSION="go1.22.7.linux-s390x.tar.gz"
BIRD_VERSION="v0.3.3-208-g1e2ff99d"
GOBUILD_VERSION="v0.92"
FORCE="false"
TESTS="false"
export SOURCE_ROOT=$(pwd)
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Calico/3.28.2/patch"
