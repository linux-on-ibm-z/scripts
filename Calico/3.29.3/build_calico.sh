...
#Description:   The script builds Calico version v3.29.3 on Linux on IBM Z for RHEL (8.8, 8.10, 9.2, 9.4, 9.5), Ubuntu (22.04, 24.04) and SLES (15 SP6).
...
#
#Download build script :   wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Calico/3.29.3/build_calico.sh
...
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Calico/3.29.3/patch"
