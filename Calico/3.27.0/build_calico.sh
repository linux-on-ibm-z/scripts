...
#
#Download build script :   wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Calico/3.27.0/build_calico.sh
...
PACKAGE_NAME="calico"
PACKAGE_VERSION="v3.27.0"
ETCD_VERSION="v3.5.10"
GOLANG_VERSION="go1.21.5.linux-s390x.tar.gz"
BIRD_VERSION="v0.3.3-202-g7a77fb7"
GOBUILD_VERSION="v0.89"
FORCE="false"
TESTS="false"
CURDIR="$(pwd)"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Calico/3.27.0/patch"
...
EOF
    ...
    if [ $(docker images 'calico/go-build:v0.89' | wc -l) == 2 ]; then
