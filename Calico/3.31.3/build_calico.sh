...
#Description:   The script builds Calico version v3.31.3 on Linux on IBM Z for RHEL (8.10, 9.4, 9.6, 9.7), Ubuntu (22.04, 24.04, 25.10) and SLES (15 SP7).
...
#
#Download build script :   wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Calico/3.31.3/build_calico.sh
...
PACKAGE_NAME="calico"
PACKAGE_VERSION="v3.31.3"
ETCD_VERSION="v3.5.6"
GOLANG_VERSION="go1.24.11.linux-s390x.tar.gz"
GOBUILD_VERSION="1.24.11-llvm18.1.8-k8s1.33.6"
K8S_VERSION="v1.33.3"
FORCE="false"
TESTS="false"
