...
#Description:   The script builds Calico version v3.31.4 on Linux on IBM Z for RHEL (8.10, 9.6, 9.7, 10.0), Ubuntu (22.04, 24.04, 25.10) and SLES (15 SP7).
...
#
#Download build script :   wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Calico/3.31.4/build_calico.sh
...
EOF
    ...
    # Build Calico images
    if [[ $DISTRO == "ubuntu-25.10" || $DISTRO == "ubuntu-24.04" ]]; then
