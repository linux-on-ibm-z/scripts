...
#Description:   The script builds Calico version v3.6.1 on Linux on IBM Z for Rhel(7.4, 7.5, 7.6), Ubuntu(16.04, 18.04) and SLES(12SP4, 15).
...
#               Build logs can be found in $HOME/Calico_v3.6.1/logs/ . Test logs can be found at $HOME/Calico_v3.6.1/logs/testLog-DATE-TIME.log.
...
quay.io/calico/node-s390x:v3.6.1
calico/node:v3.6.1
quay.io/calico/cni-s390x:v3.6.1
calico/cni:latest
