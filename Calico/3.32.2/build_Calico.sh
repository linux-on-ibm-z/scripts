...
#Description:   The script builds Calico version v3.32.2 on Linux on IBM Z for RHEL (8.10, 9.6, 9.7, 9.8, 10.0, 10.1, 10.2), Ubuntu (22.04, 24.04) and SLES (15 SP7).
...
#
#Download build script :   wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Calico/3.32.2/build_calico.sh
...
PACKAGE_NAME="calico"
PACKAGE_VERSION="v3.32.2"
GOLANG_VERSION="1.25.14"
FORCE="false"
TESTS="false"
export SOURCE_ROOT=$(pwd)
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Calico/3.32.2/patch"
