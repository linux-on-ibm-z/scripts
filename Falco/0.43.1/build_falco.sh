...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Falco/0.43.1/build_falco.sh
...
GO_VERSION="1.25.0"
PLUGINS_VERSION="0.6.4" # https://github.com/falcosecurity/falco/blob/0.43.1/CMakeLists.txt#L291
