...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Falco/0.35.0/build_falco.sh
...
function configureAndInstall() {
    ...
    else # sles-15.4, rhel-9, ubuntu-22.04+
    ...
    if [[ "${DISTRO}" =~ ^rhel-9 ]] || [[ "${DISTRO}" == "ubuntu-22.04" ]] || [[ "${DISTRO}" == "ubuntu-23.04" ]] || [[ "${DISTRO}" == "sles-15.4" ]]; then
