...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Falco/0.26.1/build_falco.sh
...
"sles-12.5")
    ...
    sudo zypper install -y gcc gcc-c++ git-core cmake ncurses-devel libjq-devel libopenssl-devel \
