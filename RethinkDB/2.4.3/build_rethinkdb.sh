...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/RethinkDB/2.4.3/build_rethinkdb.sh
# Execute build script: bash build_rethinkdb.sh    (provide -h for help)

set -e -o pipefail

PACKAGE_NAME="rethinkdb"
PACKAGE_VERSION="v2.4.3"
PRE_VERSION="v2.4.1"
CURDIR="$(pwd)"
FORCE="false"
TESTS="false"
...
function gettingStarted() {
	...
	printf -- "\n\nUsage: \n"
	printf -- "  RethinkDB v2.4.3 installed successfully \n"
