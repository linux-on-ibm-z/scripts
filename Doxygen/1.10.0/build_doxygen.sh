...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Doxygen/1.10.0/build_doxygen.sh
...
function install_cmake() {
    # Install cmake only for RHEL and SLES 12.5
