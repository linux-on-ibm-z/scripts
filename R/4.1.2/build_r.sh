  ...
  printf -- "Building R %s \n,$PACKAGE_VERSION"
   ...
   echo "Java provided by user $JAVA_PROVIDED" >> "$LOG_FILE"
    if [[ "$JAVA_PROVIDED" == "Semeru11" ]]; then
        ...
        cd "$CURDIR"
        wget https://github.com/AdoptOpenJDK/semeru11-binaries/releases/download/jdk-11.0.13%2B8_openj9-0.29.0/ibm-semeru-open-jdk_s390x_linux_11.0.13_8_openj9-0.29.0.tar.gz
	...
	cd $CURDIR
	wget https://github.com/adoptium/temurin11-binaries/releases/download/jdk-11.0.13%2B8/OpenJDK11U-jre_s390x_linux_hotspot_11.0.13_8.tar.gz
        tar -xf OpenJDK11U-jre_s390x_linux_hotspot_11.0.13_8.tar.gz
