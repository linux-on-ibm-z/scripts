...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/R/4.5.3/build_r.sh
...
"ubuntu-22.04" | "ubuntu-24.04" | "ubuntu-25.10")
  ...
  sudo DEBIAN_FRONTEND=noninteractive apt-get install -y \
    wget curl tar gcc g++ libc6-dev ratfor gfortran libx11-dev make r-base \
