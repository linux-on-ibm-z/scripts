...
case "$DISTRO" in
    ...
    "rhel-8.10" | "rhel-9.4" | "rhel-9.6" | "rhel-10.0")
        ...
        sudo yum install -y --nobest git python3 python3-pip maven genisoimage createrepo nodejs npm \
        ...
        setupNodejs 2>&1 | tee -a "$LOG_FILE"
   ...
   "ubuntu-22.04" | "ubuntu-24.04")
        ...
        printf -- "Installing dependencies... it may take some time.\n"
        sudo apt update -y
        sudo apt-get install -y curl dpkg-dev debhelper openjdk-17-jdk genisoimage build-essential python3 python3-setuptools python3-mysql.connector \
