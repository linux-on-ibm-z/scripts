...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ApacheCassandra/4.1.7/build_cassandra.sh
...
FORCE="false"
TESTS="false"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ApacheCassandra/4.1.7/patch"
...
function build_netty-tcnative() {
    cd "$CURDIR"
    wget -q https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ApacheCassandra/4.1.7/patch/build_netty.sh
    if [[ "$JAVA_PROVIDED" == "Temurin11" ]]; then
...
function configureAndInstall() {
    ...
    curl -sSL https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ApacheCassandra/4.1.7/patch/netty.patch | git apply
    ...
    curl -sSL https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ApacheCassandra/4.1.7/patch/bytes.patch | git apply
    mvn -T 1C install -DskipTests -Dmaven.javadoc.skip=true
    ...
    # Apply patch
    curl -sSL https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ApacheCassandra/4.1.7/patch/cassandra.patch | git apply
