...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ApacheCassandra/4.1.9/build_cassandra.sh
...
FORCE="false"
TESTS="false"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ApacheCassandra/4.1.9/patch"
...
"ubuntu-22.04" | "ubuntu-24.04" | "ubuntu-25.04")
    ...
    if [[ "$DISTRO" == "ubuntu-24.04" || "$DISTRO" == "ubuntu-25.04" ]]; then
