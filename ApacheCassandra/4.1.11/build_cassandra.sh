...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ApacheCassandra/4.1.11/build_cassandra.sh
...
FORCE="false"
TESTS="false"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ApacheCassandra/4.1.11/patch"
...
function prepare() {
    ...
    if [[ "$JAVA_PROVIDED" == "OpenJDK11" && "$ID" == "rhel" && ( "$VERSION_ID" == "10.0" || "$VERSION_ID" == "10.1" ) ]]; then
        err "OpenJDK11 is not supported on RHEL 10.0 and RHEL 10.1. Please use Temurin11."
