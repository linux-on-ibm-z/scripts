...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ApacheCassandra/5.0.5/build_cassandra.sh
...
function configureAndInstall() {
	...
	sed -i 's/rhel-9.5/rhel-9.6/g' build_python3.sh
