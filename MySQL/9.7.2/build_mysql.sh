...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/MySQL/9.7.2/build_mysql.sh
# Execute build script: bash build_mysql.sh    (provide -h for help)

set -e -o pipefail

PACKAGE_NAME="mysql"
PACKAGE_VERSION="9.7.2"
SOURCE_ROOT="$(pwd)"
MYSQL_INSTALL="${SOURCE_ROOT}/mysql-install"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/MySQL/9.7.2/patch"
FORCE="false"
