...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/MySQL/8.4.3/build_mysql.sh
...
function gettingStarted() {
    ...
    printf -- " MySQL 8.4.3 installed successfully.       \n"
