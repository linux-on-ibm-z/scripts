...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/MySQL/8.4.2/build_mysql.sh
...
function configureAndInstall() {
    ...
    curl -sSL "${PATCH_URL}/CMakeLists.patch" | git apply -
...
function gettingStarted() {
    ...
    printf -- " MySQL 8.4.2 installed successfully.       \n"
