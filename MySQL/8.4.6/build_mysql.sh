...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/MySQL/8.4.6/build_mysql.sh
...
SOURCE_ROOT="$(pwd)"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/MySQL/8.4.6/patch"
...
function gettingStarted() {
    ...
    printf -- " MySQL 8.4.6 installed successfully.       \n"
