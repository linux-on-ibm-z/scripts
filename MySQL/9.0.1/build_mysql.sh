...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/MySQL/9.0.1/build_mysql.sh
...
function gettingStarted() {
    ...
    printf -- " MySQL 9.0.1 installed successfully.       \n"
