...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Beats/9.2.4/build_beats.sh
...
function configureAndInstall() {
    ...
    #Adding dependencies to resolve <Python.h> and compiler issues on RHEL 9.x
    if [[ "${DISTRO}" == "rhel-9."* ]]; then
        sudo yum install -y redhat-rpm-config protobuf-compiler protobuf-devel --nobest
    fi
...
function gettingStarted() {
    ...
    printf -- '\nFor more information visit https://www.elastic.co/guide/en/beats/libbeat/8.19/getting-started.html \n'
    printf -- '*************************************************************************************************\n'
    printf -- '\n'
}
