...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Beats/7.10.1/build_beats.sh
...
#PATCH_URL
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Beats/7.10.1/patch"
...
function configureAndInstall() {
	...
	cd $CURDIR
        ...
        curl -SLO https://dl.google.com/go/go1.14.7.linux-s390x.tar.gz
        chmod ugo+r go1.14.7.linux-s390x.tar.gz
        sudo tar -C /usr/local -xzf go1.14.7.linux-s390x.tar.gz
