...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Beats/7.2.0/build_beats.sh
...
#PATCH_URL
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Beats/7.2.0/patch"
...
function configureAndInstall() {
	printf -- 'Configuration and Installation started \n'
	 ...
	 wget https://storage.googleapis.com/golang/go1.12.4.linux-s390x.tar.gz
         chmod ugo+r go1.12.4.linux-s390x.tar.gz
         sudo tar -C /usr/local -xzf go1.12.4.linux-s390x.tar.gz
