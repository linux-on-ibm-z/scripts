...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Beats/7.11.2/build_beats.sh
...
function configureAndInstall() {
        ...
        curl -SLO https://dl.google.com/go/go1.14.15.linux-s390x.tar.gz
        chmod ugo+r go1.14.15.linux-s390x.tar.gz
        sudo tar -C /usr/local -xzf go1.14.15.linux-s390x.tar.gz
