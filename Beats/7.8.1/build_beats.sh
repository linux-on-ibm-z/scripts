...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Beats/7.8.1/build_beats.sh
...
#PATCH_URL
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Beats/7.8.1/patch"
...
"ubuntu-18.04")
	...
	sudo apt-get install -y git curl make wget tar gcc libcap-dev libpcap0.8-dev openssl libssh-dev acl rsync tzdata patch fdclone libsystemd-dev libjpeg-dev python3.8 python3.8-dev python3.8-venv python3-lib2to3 |& tee -a "${LOG_FILE}"
