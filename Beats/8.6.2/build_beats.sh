...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Beats/8.6.2/build_beats.sh
...
function gettingStarted() {
    ...
    printf -- '\nFor more information visit https://www.elastic.co/guide/en/beats/libbeat/8.6/getting-started.html \n'
    printf -- '*************************************************************************************************\n'
    printf -- '\n'
}
