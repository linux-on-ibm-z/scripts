...
declare -a stateful=(
    ...
    "x-pack/solutions/security/test/kubernetes_security/basic/config.ts"
    ...
    "x-pack/solutions/security/test/security_solution_api_integration/test_suites/edr_workflows/spaces/trial_license_complete_tier/configs/endpoint_exceptions_moved_ff.ess.config.ts"
