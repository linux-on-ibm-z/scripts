...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Kibana/7.2.0/build_kibana.sh
...
function configureAndInstall() {
    ...
    git clone -b v0.25.0-alpha.20 https://github.com/elastic/nodegit.git
    cd nodegit
