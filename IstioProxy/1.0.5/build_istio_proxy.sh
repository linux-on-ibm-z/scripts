...
CURDIR="$(pwd)"
REPO_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/IstioProxy/1.0.5/patch"
ISTIO_PROXY_REPO_URL="https://github.com/istio/proxy.git"
BAZEL_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Bazel/0.15.2/build_bazel.sh"
