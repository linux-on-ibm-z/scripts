...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/netty-tcnative/2.0.79/build_netty.sh
# Execute build script: bash build_netty.sh    (provide -h for help)
#
set -e  -o pipefail
PACKAGE_NAME="netty-tcnative"
PACKAGE_VERSION="2.0.79"
...
function cleanup() {
        ...
        if [[ $JAVA_PROVIDED == *11 ]]; then
                rm -rf  ibm-semeru-open-jdk_s390x_linux_11.0.30_7_openj9-0.57.0.tar.gz
                rm -rf  OpenJDK11U-jdk_s390x_linux_hotspot_11.0.30_7.tar.gz
        elif [[ $JAVA_PROVIDED == *17 ]]; then
                rm -rf  ibm-semeru-open-jdk_s390x_linux_17.0.18_8_openj9-0.57.0.tar.gz
                rm -rf  OpenJDK17U-jdk_s390x_linux_hotspot_17.0.18_8.tar.gz
        
        else
                rm -rf  OpenJDK8U-jdk_s390x_linux_hotspot_8u292b10.tar.gz 
                rm -rf  ibm-semeru-open-jdk_s390x_linux_8u482b08_openj9-0.57.0.tar.gz
        fi
...
function configureAndInstall() {
        ...
        if [[ "$JAVA_PROVIDED" == "Semeru11" ]]; then
                ...
                cd $SOURCE_ROOT
                wget https://github.com/ibmruntimes/semeru11-binaries/releases/download/jdk-11.0.30%2B7_openj9-0.57.0/ibm-semeru-open-jdk_s390x_linux_11.0.30_7_openj9-0.57.0.tar.gz
                tar -xzf ibm-semeru-open-jdk_s390x_linux_11.0.30_7_openj9-0.57.0.tar.gz
                export JAVA_HOME=$SOURCE_ROOT/jdk-11.0.30+7
                ...
                cd $SOURCE_ROOT
                wget https://github.com/adoptium/temurin11-binaries/releases/download/jdk-11.0.30%2B7/OpenJDK11U-jdk_s390x_linux_hotspot_11.0.30_7.tar.gz
                tar -xzf OpenJDK11U-jdk_s390x_linux_hotspot_11.0.30_7.tar.gz
                export JAVA_HOME=$SOURCE_ROOT/jdk-11.0.30+7
                ...
                if [[ "${ID}" == "ubuntu" ]]; then
                        ...
                        if [[ "${VERSION_ID}" == "10.0" || "${VERSION_ID}" == "10.1" ]]; then 
                ...
                cd $SOURCE_ROOT
                wget https://github.com/ibmruntimes/semeru17-binaries/releases/download/jdk-17.0.18%2B8_openj9-0.57.0/ibm-semeru-open-jdk_s390x_linux_17.0.18_8_openj9-0.57.0.tar.gz
                tar -xzf ibm-semeru-open-jdk_s390x_linux_17.0.18_8_openj9-0.57.0.tar.gz
                export JAVA_HOME=$SOURCE_ROOT/jdk-17.0.18+8
                ...
                cd $SOURCE_ROOT
                wget https://github.com/adoptium/temurin17-binaries/releases/download/jdk-17.0.18%2B8/OpenJDK17U-jdk_s390x_linux_hotspot_17.0.18_8.tar.gz
                tar -xzf OpenJDK17U-jdk_s390x_linux_hotspot_17.0.18_8.tar.gz
                export JAVA_HOME=$SOURCE_ROOT/jdk-17.0.18+8
			...
			export JAVA_HOME=/usr/lib/jvm/`echo $java_version | cut -d' ' -f1`
                ...
                cd $SOURCE_ROOT
                wget https://github.com/ibmruntimes/semeru8-binaries/releases/download/jdk8u482-b08_openj9-0.57.0/ibm-semeru-open-jdk_s390x_linux_8u482b08_openj9-0.57.0.tar.gz
                tar -xzf ibm-semeru-open-jdk_s390x_linux_8u482b08_openj9-0.57.0.tar.gz
                export JAVA_HOME=$SOURCE_ROOT/jdk8u482-b08
