...
function cleanup() {
	rm /$CURDIR/Python-2.7.16.tar.xz
...
"ubuntu-16.04" | "ubuntu-18.04")
    	...
    	sudo apt-get update
    	sudo apt-get install -y gcc g++ make libncurses5-dev libreadline6-dev libssl-dev libgdbm-dev libc6-dev libsqlite3-dev libbz2-dev xz-utils wget tar curl bzip2 zlib1g-dev libdb1-compat libdb-dev tk-dev gdb
    	configureAndInstall
    	;;
