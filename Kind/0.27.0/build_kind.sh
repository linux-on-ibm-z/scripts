...
#
# Instructions:
# Download build script: curl -sSLO https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Kind/0.27.0/build_kind.sh
...
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Kind/0.27.0/patch"
...
function cleanup() {
	...
	rm -f $SOURCE_ROOT/go"${GOLANG_VERSION}".linux-s390x.tar.gz
