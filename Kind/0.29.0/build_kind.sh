...
#
# Instructions:
# Download build script: curl -sSLO https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Kind/0.29.0/build_kind.sh
...
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Kind/0.29.0/patch"
...
case "$DISTRO" in
"rhel-8.10" | "rhel-9.2" | "rhel-9.4" | "rhel-9.5" | "rhel-9.6")
