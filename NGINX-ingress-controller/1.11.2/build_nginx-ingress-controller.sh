...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/NGINX-ingress-controller/1.11.2/build_nginx-ingress-controller.sh
...
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/NGINX-ingress-controller/1.11.2/patch"
...
function configureAndInstall() {
    ...
    sudo make build
    sudo docker tag local/e2e-test-runner:"v$(date +%Y%m%d)-d3bb2b4" gcr.io/ingress-nginx/e2e-test-runner:v$PACKAGE_VERSION
