...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/NGINX-ingress-controller/1.10.0/build_nginx-ingress-controller.sh
...
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/NGINX-ingress-controller/1.10.0/patch"
...
function configureAndInstall() {
    ...
    cd ingress-nginx/
    git checkout controller-v$PACKAGE_VERSION
    ...
    make build
    docker tag local/e2e-test-runner:"v$(date +%Y%m%d)-dc999d81d" gcr.io/ingress-nginx/e2e-test-runner:v$PACKAGE_VERSION
