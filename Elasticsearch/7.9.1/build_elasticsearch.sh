...
function printHelp() {
        echo
        echo "Usage: "
        echo "  build_elasticsearch.sh  [-d debug] [-y install-without-confirmation] [-t install-with-tests] [-j Java to be used from {AdoptJDK11_openj9, AdoptJDK11_hotspot, OpenJDK11}]"
