...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Elasticsearch/8.6.0/build_elasticsearch.sh
...
CURDIR="$(pwd)"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Elasticsearch/8.6.0/patch/elasticsearch.patch"
...
function configureAndInstall() {
	...
	sed -i '3284,3284 s|6cd91991323dd7b2fb28ca93d7ac12af5a86a2f53279e2b35827b30313fd0b9f|'"${sha256}"'|g' ${CURDIR}/elasticsearch/gradle/verification-metadata.xml
        sed -i '28,32d' $CURDIR/elasticsearch/server/src/main/java/org/elasticsearch/common/util/BigIntArray.java
	sed -i '29,33d' $CURDIR/elasticsearch/server/src/main/java/org/elasticsearch/common/util/BigDoubleArray.java
