...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Elasticsearch/9.1.3/build_elasticsearch.sh
...
function configureAndInstall() {
    ...
    docker build --build-arg RELEASE="RELEASE.2025-06-13T11-33-47Z" --build-arg MC_RELEASE="RELEASE.2025-05-21T01-59-54Z" -t  minio/minio:RELEASE.2025-06-13T11-33-47Z --platform=linux/s390x .
