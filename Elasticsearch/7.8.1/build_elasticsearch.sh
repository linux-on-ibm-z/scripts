...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Elasticsearch/7.8.1/build_elasticsearch.sh
...
function cleanup() {
        rm -rf "${CURDIR}/OpenJDK14U-jdk_s390x_linux_hotspot_14.0.2_12.tar.gz"
	rm -rf "${CURDIR}/OpenJDK11U-jdk_s390x_linux_hotspot_11.0.8_10.tar.gz"
