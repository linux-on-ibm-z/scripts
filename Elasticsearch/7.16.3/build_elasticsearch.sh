...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Elasticsearch/7.16.3/build_elasticsearch.sh
...
CURDIR="$(pwd)"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Elasticsearch/7.16.3/patch/elasticsearch.patch"
ADOPTJDK_URL="https://github.com/adoptium/temurin16-binaries/releases/download/jdk-16.0.2%2B7/OpenJDK16U-jdk_s390x_linux_hotspot_16.0.2_7.tar.gz"
...
function configureAndInstall() {
        ...
        # Install AdoptOpenJDK 16 (With Hotspot)
        cd "$CURDIR"
        ...
        export JAVA16_HOME=/opt/adopt/java
        printf -- "export ES_JAVA_HOME=/opt/adopt/java\n" >> "$BUILD_ENV"
        printf -- "Installation of AdoptOpenJDK 16 (With Hotspot) is successful\n" >> "$LOG_FILE"
