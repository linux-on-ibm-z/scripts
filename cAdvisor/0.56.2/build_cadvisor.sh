...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/cAdvisor/0.56.2/build_cadvisor.sh
...
CURDIR="$(pwd)"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/cadvisor/0.56.2/patch"
...
function configureAndInstall() {
    ...
    tar -xzf go1.24.0.linux-s390x.tar.gz
...
function runTest() {
    ...
    if [[ "$TESTS" == "true" ]]; then
        ...
        cd "${GOPATH}/src/github.com/google/cadvisor"
        curl -sSL $PATCH_URL/test.patch | git apply --ignore-whitespace -
        make test
