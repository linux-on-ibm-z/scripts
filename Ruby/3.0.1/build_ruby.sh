...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Ruby/3.0.1/build_ruby.sh
...
function configureAndInstall()
{
  ...
  cd "${CURDIR}"
  wget http://cache.ruby-lang.org/pub/ruby/3.0/ruby-${PACKAGE_VERSION}.tar.gz
