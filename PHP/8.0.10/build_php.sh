...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/PHP/8.0.10/build_php.sh
...
patchTest()
{
  ...
  case "$DISTRO" in
    "sles-12.5" | "sles-15.2" | "sles-15.3") url=${PATCH_URL}/sles-test.diff ;;
  esac
...
"ubuntu-18.04")
  ...
  sudo apt-get install -y locales language-pack-de \
       ...
       libonig-dev libpq-dev git gcc-10 g++-10 curl tar \
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  sudo yum install -y \
    ...
    postgresql-devel pkgconfig patch make tcl |& tee -a "$LOG_FILE"
