...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/PHP/7.4.8/build_php.sh
...
patchTest()
{
  ...
  case "$DISTRO" in
    "rhel-7.6" | "rhel-7.7" | "rhel-7.8") url=${PATCH_URL}/rhel7-test.diff ;;
