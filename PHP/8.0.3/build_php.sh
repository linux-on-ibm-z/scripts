...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/PHP/8.0.3/build_php.sh
...
buildReadline8()
{
  ...
  cd "$SOURCE_ROOT"
  wget ftp://ftp.cwru.edu/pub/bash/readline-${ver}.tar.gz
