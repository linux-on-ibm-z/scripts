...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/PHP/8.4.6/build_php.sh
...
"rhel-8.8")
    ...
    sudo yum install -y \
        ...
        tar make binutils gcc-toolset-12-gcc \
        gcc-toolset-12-gcc-c++ bzip2 \
