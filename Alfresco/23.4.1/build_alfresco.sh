...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Alfresco/23.4.1/build_alfresco.sh
# Execute build script: bash build_alfresco.sh    (provide -h for help)
USER_IN_GROUP_DOCKER=$(id -nGz "$USER" | tr '\0' '\n' | grep -c '^docker$')
set -e -o pipefail

PACKAGE_NAME="alfresco"
PACKAGE_VERSION="23.4.1"
SOURCE_ROOT="$(pwd)"
FORCE="false"
TESTS="false"
...
COMMUNITY_REPO_VERSION="23.4.1.1"
COMMUNITY_SHARE_VERSION="23.4.0.46"
SEARCH_SERVICES_COMMIT="23787b7d3338aa3ac49ebaf4c646bffe1251b484"
SEARCH_SERVICES_VERSION="2.0.14"
ACS_NGINX_VERSION="3.4.2"
TRANSFORM_CORE_VERSION="5.1.5"
CONTENT_APP_VERSION="5.3.0"
