...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Alfresco/25.2.0/build_alfresco.sh
...
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Alfresco/25.2.0/patch"
MAVEN_VERSION="3.9.9"
ACTIVEMQ_VERSION="5.18.3"
ACTIVEMQ_COMMIT="f7283c546ec8a1c137a38ea3fc1db8b93299cc35"
QEMU_VERSION="v7.1.0"
JAVA_BASE_COMMIT="23a182196c8e56aff4142a7db977a6faddb00bfb"
JAVA_BASE_GENERIC_COMMIT="178324f2dd7f5b010cd93a17a414cd82d916d9b5"
TOMCAT_BASE_COMMIT="4b5c48ba4e89acd45274dee518e39588d8fa0f5d"
COMMUNITY_REPO_VERSION="25.2.0.64"
COMMUNITY_SHARE_VERSION="25.2.0.46"
SEARCH_SERVICES_COMMIT="6e2f1e1f8e7a833ef23c12587b2cf51a28d34070"
SEARCH_SERVICES_VERSION="2.0.15"
ACS_NGINX_VERSION="3.4.2"
TRANSFORM_CORE_VERSION="5.1.7"
CONTENT_APP_VERSION="6.0.0"
ACS_DOCKER_COMPOSE_COMMIT="54f99daa658ba8822b845975ca56fd66336b49a8"
...
function getJavaUrl() {
    ...
    case "${jruntime}" in
    "Temurin17")
        echo "https://github.com/adoptium/temurin17-binaries/releases/download/jdk-17.0.16%2B8/OpenJDK17U-${jdist}_s390x_linux_hotspot_17.0.16_8.tar.gz"
        return 0
        ;;
    "IBMSemeru17")
        echo "https://github.com/ibmruntimes/semeru17-binaries/releases/download/jdk-17.0.16%2B8_openj9-0.53.0/ibm-semeru-open-${jdist}_s390x_linux_17.0.16_8_openj9-0.53.0.tar.gz"
        return 0
        ;;
    "Temurin21")
	echo "https://github.com/adoptium/temurin21-binaries/releases/download/jdk-21.0.8%2B9/OpenJDK21U-${jdist}_s390x_linux_hotspot_21.0.8_9.tar.gz"
        return 0
        ;;
    "IBMSemeru21")
    	echo "https://github.com/ibmruntimes/semeru21-binaries/releases/download/jdk-21.0.8%2B9_openj9-0.53.0/ibm-semeru-open-${jdist}_s390x_linux_21.0.8_9_openj9-0.53.0.tar.gz"
        return 0
        ;;
    esac
    echo ""
...
function configureAndInstall() {
    ...
    #Pull Postgre:14.4 image
    docker pull postgres:14.4
    #Pull Traefik:3.1 image
