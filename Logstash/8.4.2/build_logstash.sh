...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Logstash/8.4.2/build_logstash.sh
...
function configureAndInstall() {
	...
	if [[ "$JAVA_PROVIDED" == "Semeru17" ]]; then
		...
		printf -- "\nInstalling Semeru17 . . . \n"
		cd $SOURCE_ROOT
		wget https://github.com/ibmruntimes/semeru17-binaries/releases/download/jdk-17.0.4.1%2B1_openj9-0.33.1/ibm-semeru-open-jdk_s390x_linux_17.0.4.1_1_openj9-0.33.1.tar.gz
		tar -xzf ibm-semeru-open-jdk_s390x_linux_17.0.4.1_1_openj9-0.33.1.tar.gz
		export LS_JAVA_HOME=$PWD/jdk-17.0.4.1+1
		printf -- "export LS_JAVA_HOME=$PWD/jdk-17.0.4.1+1\n" >> "$BUILD_ENV"
		...
		export LS_JAVA_HOME=$PWD/jdk-11.0.16.1+1
		printf -- "export LS_JAVA_HOME=$PWD/jdk-11.0.16.1+1\n" >> "$BUILD_ENV"
