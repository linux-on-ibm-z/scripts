...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Logstash/8.6.2/build_logstash.sh
...
function cleanup() {
        sudo rm -rf "${CURDIR}/logstash-oss-${PACKAGE_VERSION}-linux-aarch64.tar.gz" "${CURDIR}/OpenJDK17U-jdk_s390x_linux_hotspot_17.0.5_8.tar.gz" "${CURDIR}/OpenJDK11U-jdk_s390x_linux_hotspot_11.0.18_10.tar.gz"
...
function configureAndInstall() {
    ...
    if [[ "$JAVA_PROVIDED" == "Temurin11" ]]; then
        ...
        tar -xzf OpenJDK11U-jdk_s390x_linux_hotspot_11.0.18_10.tar.gz
        export LS_JAVA_HOME=$PWD/jdk-11.0.18+10
        ...
        cd $SOURCE_ROOT
        wget https://github.com/adoptium/temurin17-binaries/releases/download/jdk-17.0.5%2B8/OpenJDK17U-jdk_s390x_linux_hotspot_17.0.5_8.tar.gz
        tar -xzf OpenJDK17U-jdk_s390x_linux_hotspot_17.0.5_8.tar.gz
