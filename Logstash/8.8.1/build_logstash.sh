...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Logstash/8.8.1/build_logstash.sh
...
function cleanup() {
        sudo rm -rf "${CURDIR}/logstash-oss-${PACKAGE_VERSION}-linux-aarch64.tar.gz" "${CURDIR}/OpenJDK17U-jdk_s390x_linux_hotspot_17.0.7_7.tar.gz" "${CURDIR}/OpenJDK11U-jdk_s390x_linux_hotspot_11.0.19_7.tar.gz"
