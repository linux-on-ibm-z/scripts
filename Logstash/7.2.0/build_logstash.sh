...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Logstash/7.2.0/build_logstash.sh
...
function configureAndInstall() {
        ...
        cd /usr/local/jffi
        ant
        export LD_LIBRARY_PATH="/usr/local/jffi/build/jni/:$LD_LIBRARY_PATH"
