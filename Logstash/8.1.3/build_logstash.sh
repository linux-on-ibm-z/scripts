...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Logstash/8.1.3/build_logstash.sh
...
function cleanup() {
        sudo rm -rf "${CURDIR}/logstash-oss-${PACKAGE_VERSION}-linux-aarch64.tar.gz" "${CURDIR}/ibm-semeru-open-jdk_s390x_linux_11.0.15_10_openj9-0.32.0.tar.gz" "${CURDIR}/OpenJDK11U-jdk_s390x_linux_hotspot_11.0.15_10.tar.gz"
...
function configureAndInstall() {
	...
	if [[ "$JAVA_PROVIDED" == "Semeru11" ]]; then
		...
		printf -- "\nInstalling Semeru11 . . . \n"
		cd $SOURCE_ROOT
		wget https://github.com/ibmruntimes/semeru11-binaries/releases/download/jdk-11.0.15%2B10_openj9-0.32.0/ibm-semeru-open-jdk_s390x_linux_11.0.15_10_openj9-0.32.0.tar.gz
		tar -xzf ibm-semeru-open-jdk_s390x_linux_11.0.15_10_openj9-0.32.0.tar.gz
		export LS_JAVA_HOME=$PWD/jdk-11.0.15+10
		printf -- "export LS_JAVA_HOME=$PWD/jdk-11.0.15+10\n" >> "$BUILD_ENV"
		...
		cd $SOURCE_ROOT
		wget https://github.com/adoptium/temurin11-binaries/releases/download/jdk-11.0.15%2B10/OpenJDK11U-jdk_s390x_linux_hotspot_11.0.15_10.tar.gz
		tar -xzf OpenJDK11U-jdk_s390x_linux_hotspot_11.0.15_10.tar.gz
		export LS_JAVA_HOME=$PWD/jdk-11.0.15+10
		printf -- "export LS_JAVA_HOME=$PWD/jdk-11.0.15+10\n" >> "$BUILD_ENV"
