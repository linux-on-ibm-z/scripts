...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Logstash/8.7.1/build_logstash.sh
...
function configureAndInstall() {
    ...
    if [[ "$JAVA_PROVIDED" == "Temurin11" ]]; then
        ...
        export LS_JAVA_HOME=$PWD/jdk-11.0.19+7
        ...
        export LS_JAVA_HOME=$PWD/jdk-17.0.7+7
