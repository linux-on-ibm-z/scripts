...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Logstash/7.8.0/build_logstash.sh
...
function configureAndInstall() {
	...
	export PATH=$JAVA_HOME/bin:$PATH
        ...
        # Install jffi ( RHEL/SLES/Ubuntu20.04 )
	if [[ "$ID" == "rhel" || "$ID" == "sles" || "$ID" == "ubuntu-20.04" ]]; then
