...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Htop/3.2.2/build_htop.sh
...
function configureAndInstall() {
	...
	# Download and unpack the htop 3.2.2 source code
	cd /"$CURDIR"/
	git clone -b $PACKAGE_VERSION https://github.com/htop-dev/htop.git
 	cd htop

	# Configure and build htop-3.2.2
	cd /"$CURDIR"/htop
	./autogen.sh
	./configure
	make
