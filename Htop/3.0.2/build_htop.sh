...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Htop/3.0.2/build_htop.sh
...
function configureAndInstall() {
	...
	# Download and unpack the htop 3.0.2 source code
	cd /"$CURDIR"/
	wget https://github.com/htop-dev/htop/archive/3.0.2.tar.gz
	tar xvzf 3.0.2.tar.gz

	# Configure and build htop-3.0.2
	cd /"$CURDIR"/htop-3.0.2
	bash autogen.sh
	./configure
	make
