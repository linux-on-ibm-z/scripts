...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/OpenResty/1.19.3.1/build_openresty.sh
...
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/OpenResty/1.19.3.1/patch"
...
function runTest() {
    ...
    if [[ "$TESTS" == "true" ]]; then
        ...
        #Make changes to $SOURCE_ROOT/openresty-1.19.3.1/t/Config.pm
