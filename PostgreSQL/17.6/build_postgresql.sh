...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/PostgreSQL/17.6/build_postgresql.sh
...
function gettingStarted() {
        ...
        printf -- "  More information on starting the postgresql server can be found here : https://github.com/linux-on-ibm-z/docs/wiki/Building-PostgreSQL-17.x \n"
        printf -- '\n'
}
