...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/PostgreSQL/18.1/build_postgresql.sh
...
function gettingStarted() {
        ...
        printf -- "  More information on starting the postgresql server can be found here : https://github.com/linux-on-ibm-z/docs/wiki/Building-PostgreSQL-18.x \n"
        printf -- '\n'
}
...
"rhel-8.10" | "rhel-9.4" | "rhel-9.6" | "rhe-9.7" | "rhel-10.0" | "rhel-10.1")
        ...
        if [[ "$VERSION_ID" == "9.4" ||  "$VERSION_ID" == "9.6" || "$VERSION_ID" == "10.0" ]]; then
