...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/PostgreSQL/17.2/build_postgresql.sh
...
"rhel-8.8" | "rhel-8.10" | "rhel-9.2" | "rhel-9.4" | "rhel-9.5")
        ...
        if [[ "$VERSION_ID" == "9.2" ||  "$VERSION_ID" == "9.4" ||  "$VERSION_ID" == "9.5" ]]; then
