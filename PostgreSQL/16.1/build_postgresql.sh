...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/PostgreSQL/16.1/build_postgresql.sh
...
"rhel-7.8" | "rhel-7.9" | "rhel-8.6" | "rhel-8.8" | "rhel-8.9" | "rhel-9.0" | "rhel-9.2" | "rhel-9.3")
        ...
        if [[ "$VERSION_ID" == "8.6" || "$VERSION_ID" == "8.8" || "$VERSION_ID" == "8.9" || "$VERSION_ID" == "9.0" || "$VERSION_ID" == "9.2" || "$VERSION_ID" == "9.3" ]]; then
