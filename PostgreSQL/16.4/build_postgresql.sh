...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/PostgreSQL/16.4/build_postgresql.sh
...
"rhel-8.8" | "rhel-8.10" | "rhel-9.2" | "rhel-9.4")
        ...
        if [[ "$VERSION_ID" == "8.8" ||  "$VERSION_ID" == "8.10" || "$VERSION_ID" == "9.2" ||  "$VERSION_ID" == "9.4" ]]; then
