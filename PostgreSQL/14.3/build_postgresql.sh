...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/PostgreSQL/14.3/build_postgresql.sh
...
"rhel-7.8" | "rhel-7.9" | "rhel-8.4" | "rhel-8.5" | "rhel-8.6" )
        ...
        if [[ "$VERSION_ID" == "8.4" || "$VERSION_ID" == "8.5" || "$VERSION_ID" == "8.6" ]]; then
