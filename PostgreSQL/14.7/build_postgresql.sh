...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/PostgreSQL/14.7/build_postgresql.sh
...
"rhel-7.8" | "rhel-7.9" | "rhel-8.4" | "rhel-8.6" | "rhel-8.7" | "rhel-9.0" | "rhel-9.1" )
        ...
        if [[ "$VERSION_ID" == "8.4" || "$VERSION_ID" == "8.6" || "$VERSION_ID" == "8.7" || "$VERSION_ID" == "9.0" ]]; then
