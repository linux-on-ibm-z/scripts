...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/PostgreSQL/15.14/build_postgresql.sh
...
"rhel-8.10" | "rhel-9.4" | "rhel-9.6" | "rhel-10.0")
        ...
        elif [[ "$VERSION_ID" == "9.4" || "$VERSION_ID" == "9.6" || "$VERSION_ID" == "10.0" ]]; then
