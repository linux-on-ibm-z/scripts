...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/PostgreSQL/17.5/build_postgresql.sh
...
"rhel-8.10" | "rhel-9.4" | "rhel-9.5")
        ...
        if [[ "$VERSION_ID" == "9.4" ||  "$VERSION_ID" == "9.5" ]]; then
