...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/etcd/3.4.3/build_etcd.sh
...
function configureAndInstall() {
    ...
    chmod ugo+r go1.13.3.linux-s390x.tar.gz 
