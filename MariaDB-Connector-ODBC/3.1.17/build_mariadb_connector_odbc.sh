...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/MariaDB-Connector-ODBC/3.1.17/build_mariadb_connector_odbc.sh
...
"ubuntu-18.04")
    ...
    wget -q https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/MariaDB/10.9.3/build_mariadb.sh
