...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/MariaDB-Connector-ODBC/3.2.7/build_mariadb_connector_odbc.sh
...
function installUnixODBC() {
    ...
    cd $SOURCE_ROOT
    git clone -b 2.3.12 https://github.com/lurcher/unixODBC.git
    cd unixODBC
    autoreconf -fi
    ./configure
    make
