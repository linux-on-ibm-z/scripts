...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/MariaDB-Connector-ODBC/3.1.11/build_mariadb_connector_odbc.sh
...
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/MariaDB-Connector-ODBC/3.1.11/patch"
...
function configureAndInstall() {
    ...
    #Code changes
    curl -sSL ${PATCH_URL}/odbc.patch | patch -p1 || echo "Error"
