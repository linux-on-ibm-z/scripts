...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/MariaDB-Connector-ODBC/3.1.16/build_mariadb_connector_odbc.sh
...
function runTest() {
    ...
    if [[ "$TESTS" == "true" ]]; then
        ...
        if [[ "$DISTRO" == "sles"* || "$DISTRO" == "rhel-8"* ]]; then
...
"ubuntu-18.04")
    ...
    wget -q https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/MariaDB/10.8.3/build_mariadb.sh
