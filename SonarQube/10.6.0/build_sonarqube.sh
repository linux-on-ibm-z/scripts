...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/SonarQube/10.6.0/build_sonarqube.sh
# Execute build script: bash build_sonarqube.sh    (provide -h for help)

set -e -o pipefail

PACKAGE_NAME="sonarqube"
PACKAGE_VERSION="10.6.0.92116"
SONAR_VERSION="10.6.0"
SCANNER_VERSION="6.1.0.4477"
NODEJS_VERSION="v20.12.2"
ES_VERSION="8.13.4" #https://github.com/SonarSource/sonarqube/blob/10.6.0.92116/gradle.properties#L16
