...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/SonarQube/10.4.1/build_sonarqube.sh
# Execute build script: bash build_sonarqube.sh    (provide -h for help)

set -e -o pipefail

PACKAGE_NAME="sonarqube"
PACKAGE_VERSION="10.4.1.88267"
SONAR_VERSION="10.4.1"
SCANNER_VERSION="5.0.1.3006"
NODEJS_VERSION="v16.18.1"
ES_VERSION="8.11.0" #https://github.com/SonarSource/sonarqube/blob/10.4.1.88267/gradle.properties#L9
