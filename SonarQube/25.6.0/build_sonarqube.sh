...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/SonarQube/25.6.0/build_sonarqube.sh
# Execute build script: bash build_sonarqube.sh    (provide -h for help)

set -e -o pipefail

PACKAGE_NAME="sonarqube"
PACKAGE_VERSION="25.6.0.109173"
SONAR_VERSION="25.6.0"
SCANNER_VERSION="7.1.0.4889"
NODEJS_VERSION="v24.2.0"
ES_VERSION="8.16.3" #https://github.com/SonarSource/sonarqube/blob/25.6.0.109173/gradle.properties#L14
ZSTD_VERSION=1.5.5
SOURCE_ROOT="$(pwd)"
BUILD_DIR="/usr/local"
