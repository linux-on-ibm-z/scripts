...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/SonarQube/10.5.1/build_sonarqube.sh
# Execute build script: bash build_sonarqube.sh    (provide -h for help)

set -e -o pipefail

PACKAGE_NAME="sonarqube"
PACKAGE_VERSION="10.5.1.90531"
SONAR_VERSION="10.5.1"
SCANNER_VERSION="5.0.1.3006"
NODEJS_VERSION="v22.2.0"
ES_VERSION="8.11.0" #https://github.com/SonarSource/sonarqube/blob/10.5.1.90531/gradle.properties#L16
...
function installElasticsearch() {
    ...
    cd $SOURCE_ROOT
    PATCH_URL=https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/SonarQube/10.5.1/patch/elasticsearch.diff
    export LANG="en_US.UTF-8"
    export ES_JAVA_HOME=$JAVA_HOME
    export JAVA17_HOME=$JAVA_HOME

    git clone -b v$ES_VERSION --depth 1 https://github.com/elastic/elasticsearch
    cd elasticsearch
...
function runTest() {
    ...
    if [[ "$TESTS" == "true" ]]; then
        ...
        #Run Javacript scanner (except for  SLES 12 SP5)
