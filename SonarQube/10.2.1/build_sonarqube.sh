...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/SonarQube/10.2.1/build_sonarqube.sh
# Execute build script: bash build_sonarqube.sh    (provide -h for help)

set -e -o pipefail

PACKAGE_NAME="sonarqube"
PACKAGE_VERSION="10.2.1.78527"
SONAR_VERSION="10.2.1"
SCANNER_VERSION="5.0.1.3006"
NODEJS_VERSION="v16.18.1"
ES_VERSION="8.7.0" #https://github.com/SonarSource/sonarqube/blob/10.2.1.78527/gradle.properties#L9
...
function installJava() {
    ...
    if [[ "$JAVA_PROVIDED" == "Temurin_17" ]]; then
        ...
        cd "$SOURCE_ROOT"
        sudo wget -O temurin17.tar.gz -q https://github.com/adoptium/temurin17-binaries/releases/download/jdk-17.0.8.1%2B1/OpenJDK17U-jdk_s390x_linux_hotspot_17.0.8.1_1.tar.gz
...
function installElasticsearch() {
    ...
    #fix download issue with ML-CPP on older ES: https://github.com/elastic/elasticsearch/issues/94446
    curl -sSL https://github.com/elastic/elasticsearch/commit/eea68d74e1e7ac7f9dd5d7157c72641b470c2499.patch | git apply
