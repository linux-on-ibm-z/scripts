...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/SonarQube/26.1.0/build_sonarqube.sh
# Execute build script: bash build_sonarqube.sh    (provide -h for help)

set -e -o pipefail

PACKAGE_NAME="sonarqube"
PACKAGE_VERSION="26.1.0.118079"
SONAR_VERSION="26.1.0"
SCANNER_VERSION="7.2.0.5079"
NODEJS_VERSION="v24.2.0"
ES_VERSION="8.17.0" #https://github.com/SonarSource/sonarqube/blob/26.1.0.118079/gradle.properties#ll15
ZSTD_VERSION=1.5.5
SOURCE_ROOT="$(pwd)"
BUILD_DIR="/usr/local"
