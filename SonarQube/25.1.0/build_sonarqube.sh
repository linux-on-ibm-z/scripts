...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/SonarQube/25.1.0/build_sonarqube.sh
# Execute build script: bash build_sonarqube.sh    (provide -h for help)

set -e -o pipefail

PACKAGE_NAME="sonarqube"
PACKAGE_VERSION="25.1.0.102122"
SONAR_VERSION="25.1.0"
SCANNER_VERSION="6.2.0.4584"
NODEJS_VERSION="v20.12.2"
ES_VERSION="8.14.3" #https://github.com/SonarSource/sonarqube/blob/25.1.0.102122/gradle.properties#L14
