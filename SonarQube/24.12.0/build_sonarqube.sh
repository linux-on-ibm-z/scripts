...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/SonarQube/24.12.0/build_sonarqube.sh
# Execute build script: bash build_sonarqube.sh    (provide -h for help)

set -e -o pipefail

PACKAGE_NAME="sonarqube"
PACKAGE_VERSION="24.12.0.100206"
SONAR_VERSION="24.12.0"
SCANNER_VERSION="6.2.0.4584"
NODEJS_VERSION="v20.12.2"
ES_VERSION="8.14.3" #https://github.com/SonarSource/sonarqube/blob/24.12.0.100206/gradle.properties#L14
