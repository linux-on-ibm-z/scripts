...
#
#Instructions
#Get Build script : wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Python3/3.8.2/build_python3.sh
...
function runTest() {
        ...
        if [[ "$TESTS" == "true" ]]; then
                ...
                if [[ $? != 0 ]]; then      
                        ...
                        sed '/tests skipped/q' tests_failed.log >> rerun_tests.log 
                        sed -i '$d' rerun_tests.log 
...
function printHelp() {
        ...
        echo "This script supports Python version 3.8.2"
        echo
}
