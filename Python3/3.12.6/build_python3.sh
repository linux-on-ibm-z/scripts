...
#
#Instructions
#Get Build script : wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Python3/3.12.6/build_python3.sh
...
function printHelp() {
        ...
        echo "This script supports Python version 3.12.6"
        echo
}
