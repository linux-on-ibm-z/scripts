...
#
#Instructions
#Get Build script : wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Python3/3.10.6/build_python3.sh
...
TESTS="false"
PATCH="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Python3/${PACKAGE_VERSION}/patch"
FORCE="false"
CURDIR="$(pwd)"
...
function runTest() {
        ...
        if [[ "$TESTS" == "true" ]]; then
                ...
                cd "$CURDIR/Python-${PACKAGE_VERSION}"
                curl -o zlib.patch $PATCH/zlib.patch
                patch --ignore-whitespace $CURDIR/Python-${PACKAGE_VERSION}/Lib/test/test_zlib.py < zlib.patch
...
function printHelp() {
        ...
        echo "This script supports Python version 3.10.6"
        echo
}
