...
#
#Instructions
#Get Build script : wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Python3/3.10.3/build_python3.sh
...
TESTS="false"
PATCH="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Python3/3.10.3/patch"
FORCE="false"
CURDIR="$(pwd)"
...
function printHelp() {
        ...
        echo "This script supports Python version 3.10.3"
        echo
}
