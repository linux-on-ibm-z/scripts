...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Bazel/4.2.2/build_bazel.sh
...
function configureAndInstall() {
	...
	# Download Bazel 4.2.2 distribution archive
	printf -- '\nDownload Bazel 4.2.2 distribution archive..... \n'
	cd $SOURCE_ROOT
