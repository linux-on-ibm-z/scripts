...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Bazel/9.2.0/build_bazel.sh
...
SOURCE_ROOT="$(pwd)"
USER="$(whoami)"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Bazel/9.2.0/patch"
...
function configureAndInstall() {
	...
	${SOURCE_ROOT}/dist/bazel/output/bazel build //src:bazel --compilation_mode=opt --stamp --embed_label=9.2.0
    mkdir -p output
