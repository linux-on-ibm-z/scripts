...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Bazel/7.0.2/build_bazel.sh
...
function configureAndInstall() {
    ...
    # Download and patch rules_java v7.1.0
    #printf -- '\nDownload and patch rules_java v7.1.0... \n'
    cd $SOURCE_ROOT
    git clone -b 7.1.0 https://github.com/bazelbuild/rules_java.git
    cd rules_java
    curl -sSL $PATCH_URL/rules_java_7.1.0.patch | git apply || error "Patch rules_java v7.1.0"
