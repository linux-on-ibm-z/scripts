...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Bazel/4.0.0/build_bazel.sh
...
SOURCE_ROOT="$(pwd)"
USER="$(whoami)"
PATCH="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Bazel/4.0.0/patch"
...
function configureAndInstall() {
	...
	# Download Bazel 4.0.0 distribution archive
	printf -- '\nDownload Bazel 4.0.0 distribution archive..... \n'
	cd $SOURCE_ROOT
