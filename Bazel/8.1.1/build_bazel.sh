...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Bazel/8.1.1/build_bazel.sh
...
SOURCE_ROOT="$(pwd)"
USER="$(whoami)"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Bazel/8.1.1/patch"
...
-//src/java_tools/import_deps_checker/... -//src/test/shell/bazel/android/... -//src/test/shell/bazel:bazel_determinism_test -//src/test/shell/bazel:bazel_android_tools_test
...
"ubuntu-20.04")
    ...
    sudo DEBIAN_FRONTEND=noninteractive apt-get install -y --no-install-recommends \
        ...
        lcov less libssl-dev lsb-release netcat-openbsd openjdk-21-jdk-headless zip zlib1g-dev unzip wget \
...
"ubuntu-22.04" | "ubuntu-24.04" | "ubuntu-24.10")
    ...
    sudo DEBIAN_FRONTEND=noninteractive apt-get install -y --no-install-recommends \
        bind9-host build-essential coreutils curl dnsutils ed expect file git gnupg2 iproute2 iputils-ping mkisofs \
        lcov less libssl-dev lsb-release netcat-openbsd openjdk-21-jdk-headless zip zlib1g-dev unzip wget python3 |& tee -a "${LOG_FILE}"
