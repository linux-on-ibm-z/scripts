...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ApacheMesos/1.8.0/build_mesos.sh
...
REPO_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ApacheMesos/1.8.0/patch"
...
function configureAndInstall() {
    ...
    cd curl
    git checkout curl-7_64_0
    ./buildconf
    ./configure --prefix=/opt/curl --disable-libcurl-option --disable-shared
    make
    sudo make install
    ...
    # Patch boost-1.65.0.patch file
	curl -o "boost-1.65.0.patch.diff"  $REPO_URL/boost-1.65.0.patch.diff
	# replace patch file
	patch "${CURDIR}/mesos/3rdparty/boost-1.65.0.patch" boost-1.65.0.patch.diff
	printf -- 'Patched boost-1.65.0.patch \n'
