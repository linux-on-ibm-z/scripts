...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Puppet/8.4.0/build_puppet.sh
...
TEMURIN_JDK11_URL="https://github.com/adoptium/temurin11-binaries/releases/download/jdk-11.0.21%2B9/OpenJDK11U-jdk_s390x_linux_hotspot_11.0.21_9.tar.gz"
TEMURIN_JDK17_URL="https://github.com/adoptium/temurin17-binaries/releases/download/jdk-17.0.10%2B7/OpenJDK17U-jdk_s390x_linux_hotspot_17.0.10_7.tar.gz"
SEMERU_JDK11_URL="https://github.com/ibmruntimes/semeru11-binaries/releases/download/jdk-11.0.21%2B9_openj9-0.41.0/ibm-semeru-open-jdk_s390x_linux_11.0.21_9_openj9-0.41.0.tar.gz"
SEMERU_JDK17_URL="https://github.com/ibmruntimes/semeru17-binaries/releases/download/jdk-17.0.9%2B9_openj9-0.41.0/ibm-semeru-open-jdk_s390x_linux_17.0.9_9_openj9-0.41.0.tar.gz"
...
function cleanup() {
        ...
        sudo rm -rf $SOURCE_ROOT/ruby-3.3.0
...
if [[ "$USEAS" == "server" ]]; then
        ...
        *)
        ...
        "sles-12.5")
                printf -- "Installing %s Agent %s for %s \n" "$PACKAGE_NAME" "$AGENT_VERSION" "$DISTRO" |& tee -a "$LOG_FILE"
                printf -- "Installing the dependencies for $PACKAGE_NAME from repository \n" |& tee -a "$LOG_FILE"
                sudo zypper install -y gcc7-c++ tar libopenssl-devel make wget gzip gawk zlib-devel bison flex readline-devel gdbm-devel libyaml-devel |& tee -a "$LOG_FILE"                 
                sudo ln -sf /usr/bin/gcc-7 /usr/bin/gcc
                sudo ln -sf /usr/bin/gcc /usr/bin/cc    
                configureAndInstall |& tee -a "$LOG_FILE"
                ;;
