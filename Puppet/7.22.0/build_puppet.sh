...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Puppet/7.22.0/build_puppet.sh
...
SOURCE_ROOT="$(pwd)"
PACKAGE_NAME="Puppet"
PACKAGE_VERSION="7.22.0"
SERVER_VERSION="7.9.3"
AGENT_VERSION="7.22.0"
RUBY_VERSION="2.7"
RUBY_FULL_VERSION="2.7.7"
