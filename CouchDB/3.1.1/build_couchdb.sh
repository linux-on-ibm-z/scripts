...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/CouchDB/3.1.1/build_couchdb.sh
...
function printSummary() {
	...
	printf -- '\nFor more help visit http://docs.couchdb.org/en/3.1.1/index.html \n' |& tee -a "$LOG_FILE"
}
