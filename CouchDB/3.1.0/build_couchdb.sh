...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/CouchDB/3.1.0/build_couchdb.sh
...
CURDIR="$(pwd)"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/CouchDB/${PACKAGE_VERSION}/patch"
...
function printSummary() {
	...
	printf -- '\nFor more help visit http://docs.couchdb.org/en/3.1.0/index.html \n' |& tee -a "$LOG_FILE"
}
