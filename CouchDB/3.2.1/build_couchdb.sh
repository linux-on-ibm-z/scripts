...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/CouchDB/3.2.1/build_couchdb.sh
...
CURDIR="$(pwd)"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/CouchDB/3.2.1/patch"
...
function configureAndInstall() {
  ...
  #Install Erlang
  cd "${CURDIR}"
  wget http://www.erlang.org/download/otp_src_24.1.tar.gz
  tar zxf otp_src_24.1.tar.gz
  cd otp_src_24.1
  export ERL_TOP="${CURDIR}/otp_src_24.1"
  ./configure --prefix=/usr
  make
  sudo make install
...
function printSummary() {
	...
	printf -- '\nFor more help visit http://docs.couchdb.org/en/3.2.1/index.html \n' |& tee -a "$LOG_FILE"
}
