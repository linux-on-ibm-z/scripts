...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/HAProxy/2.1.0/build_haproxy.sh
...
function configureAndInstall() {
    ...
    # Download HAProxy
	cd "$CURDIR"
    wget "http://www.haproxy.org/download/2.1/src/haproxy-${PACKAGE_VERSION}.tar.gz"
