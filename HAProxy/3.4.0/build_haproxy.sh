...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/HAProxy/3.4.0/build_haproxy.sh
...
function configureAndInstall() {
    ...
    # Download HAProxy
    cd "$CURDIR"
    wget "https://www.haproxy.org/download/3.4/src/haproxy-${PACKAGE_VERSION}.tar.gz"
