...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ApacheHttpServer/2.4.49/build_apachehttpserver.sh
...
function configureAndInstall() {
	...
	if [[ "$ID-$VERSION_ID" == "rhel-8.2" ]] || [[ "$ID-$VERSION_ID" == "rhel-8.4" ]]; then
