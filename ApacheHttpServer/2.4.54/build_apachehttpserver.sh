...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ApacheHttpServer/2.4.54/build_apachehttpserver.sh
...
function configureAndInstall() {
	...
	if [[ "$ID-$VERSION_ID" == "rhel-8.4" ]] || [[ "$ID-$VERSION_ID" == "rhel-8.5" ]] || [[ "$ID-$VERSION_ID" == "rhel-8.6" ]]; then
