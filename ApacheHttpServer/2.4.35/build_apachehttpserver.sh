...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ApacheHttpServer/2.4.35/build_apachehttpserver.sh
# Execute build script: bash build_apachehttpserver.sh    (provide -h for help)

set -e -o pipefail

PACKAGE_NAME="apachehttpserver"
PACKAGE_VERSION="2.4.35"
APR_VERSION="1.6.5"
...
function configureAndInstall() {
	...
	#Add apachectl to /usr/bin
	sudo cp $BUILD_DIR/bin/apachectl /usr/bin/
