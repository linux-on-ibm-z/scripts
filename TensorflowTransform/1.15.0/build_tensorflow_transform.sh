...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/TensorflowTransform/1.15.0/build_tensorflow_transform.sh
...
CURDIR="$(pwd)"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/TensorflowTransform/1.15.0/patch"
TENSORFLOW_INSTALL_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Tensorflow/2.16.1/build_tensorflow.sh"
FORCE="false"
TESTS="false"
...
function configureAndInstall() {
    ...
    sed -i '329a sudo pip3 install --upgrade pip' build_tensorflow.sh
    ...
    cd "${CURDIR}"
    git clone -b v${PACKAGE_VERSION} https://github.com/tensorflow/transform.git
    cd transform
