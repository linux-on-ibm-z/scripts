...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/CockroachDB/25.2.8/build_crdb.sh
...
GO_VERSION="1.22.8"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/CockroachDB/25.2.8/patch"
FORCE="false"
TEST="false"
...
EOF
    ...
    ./dev doctor
    ./dev build
	if [[ "$DISTRO" == "rhel-10.0" || "$DISTRO" == "ubuntu-24.04" || "$DISTRO" == "ubuntu-25.04" || "$DISTRO" == "ubuntu-25.10" ]]; then
