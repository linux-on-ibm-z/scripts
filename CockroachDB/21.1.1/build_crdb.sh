...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/CockroachDB/21.1.1/build_crdb.sh
...
function cleanup() {
	sudo rm -rf ${CURDIR}/go1.15.6.linux-s390x.tar.gz
...
function configureAndInstall() {
	...
	chmod ugo+r go1.15.6.linux-s390x.tar.gz
