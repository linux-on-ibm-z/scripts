...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/CockroachDB/24.3.14/build_crdb.sh
...
PACKAGE_VERSION="24.3.14"
GO_VERSION="1.22.8"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/CockroachDB/24.3.14/patch"
FORCE="false"
TEST="false"
...
function configureAndInstall() {
    ...
    if [ ! -d  $CURDIR/goroot ]; then
        ...
        cd goroot
        wget -O go.patch https://raw.githubusercontent.com/cockroachdb/cockroach/v24.3.14/build/teamcity/internal/release/build-and-publish-patched-go/diff.patch
