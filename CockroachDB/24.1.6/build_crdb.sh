...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/CockroachDB/24.1.6/build_crdb.sh
...
GO_VERSION="1.22.5"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/CockroachDB/24.1.6/patch"
FORCE="false"
TEST="false"
...
function configureAndInstall() {
    ...
    if [ ! -d  $CURDIR/goroot ]; then
        ...
        cd goroot
        wget -O go.patch https://raw.githubusercontent.com/cockroachdb/cockroach/v24.1.6/build/teamcity/internal/release/build-and-publish-patched-go/diff.patch
