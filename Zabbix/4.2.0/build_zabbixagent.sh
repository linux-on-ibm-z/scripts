...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Zabbix/4.2.0/build_zabbixagent.sh
...
function printHelp() {
	echo
	echo "Usage: "
	echo "  build_zabbixagent.sh [-d debug]"
	echo
}
