...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Zabbix/6.0.13/build_zabbixserver.sh
...
"sles-15.4")
  ...
  sudo zypper install -y wget tar curl vim gcc make net-snmp net-snmp-devel net-tools git apache2 apache2-devel mariadb \
        libmariadbd-devel apache2-mod_php7 php7 php7-mysql php7-xmlreader php7-xmlwriter php7-gd php7-bcmath php7-mbstring \
        php7-ctype php7-sockets php7-gettext libcurl-devel libxml2-2 libxml2-devel openldap2-devel php7-ldap \
