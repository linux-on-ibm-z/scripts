...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Couchbase/7.6.5/build_couchbase.sh
...
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Couchbase/7.6.5/patch"
...
function prepareUB24() {
    ...
    sudo DEBIAN_FRONTEND=noninteractive TZ=America/Toronto apt-get install -y \
        ...
        g++-11 gcc-11 gcc-11-multilib g++-11-multilib libglib2.0-dev libtool tar unzip software-properties-common
...
function buildGrpc() {
    ...
    if [ $ID$VERSION_ID == "ubuntu22.04" ] || [ $ID$VERSION_ID == "ubuntu24.04" ] || [ $ID$VERSION_ID == "rhel9."* ]; then
