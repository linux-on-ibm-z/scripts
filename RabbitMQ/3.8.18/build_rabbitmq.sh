...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/RabbitMQ/3.8.18/build_rabbitmq.sh
...
function configureAndInstall() {
	...
	wget -q https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Erlang/23.3/build_erlang.sh
