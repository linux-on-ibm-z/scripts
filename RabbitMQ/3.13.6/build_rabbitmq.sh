...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/RabbitMQ/3.13.6/build_rabbitmq.sh
...
function configureAndInstall() {
	...
	if [[ "$DISTRO" == "sles-15.6" ]]; then
		...
		sed -i '361i "sles-15.5" | "sles-15.6")' build_erlang.sh
