...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/RabbitMQ/3.12.3/build_rabbitmq.sh
...
case "$DISTRO" in
"ubuntu-20.04" | "ubuntu-22.10" | "ubuntu-22.04" | "ubuntu-23.04")
