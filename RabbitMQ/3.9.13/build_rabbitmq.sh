...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/RabbitMQ/3.9.13/build_rabbitmq.sh
...
function installPython() {
  cd "${CURDIR}"
  wget -q https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Python3/3.10.1/build_python3.sh
...
function configureAndInstall() {
	...
	# Install Erlang
	printf -- "\nBuilding Erlang \n"
	wget -q https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Erlang/24.2/build_erlang.sh
