...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/minio/2025-04-08T15-41-24Z/build_minio.sh
# Execute build script: bash build_minio.sh    (provide -h for help)

set -e -o pipefail

PACKAGE_NAME="minio"
PACKAGE_VERSION="RELEASE.2025-04-08T15-41-24Z"
MC_PACKAGE_VERSION="RELEASE.2025-04-08T15-39-49Z"
CURDIR="$(pwd)"
SOURCE_ROOT="$(pwd)"
FORCE="false"
