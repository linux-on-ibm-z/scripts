...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/minio/2024-12-18T13-15-44Z/build_minio.sh
# Execute build script: bash build_minio.sh    (provide -h for help)

set -e -o pipefail

PACKAGE_NAME="minio"
PACKAGE_VERSION="RELEASE.2024-12-18T13-15-44Z"
MC_PACKAGE_VERSION="RELEASE.2024-11-21T17-21-54Z "
CURDIR="$(pwd)"
SOURCE_ROOT="$(pwd)"
FORCE="false"
