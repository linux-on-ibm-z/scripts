...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Sysdig/0.33.1/build_sysdig.sh
...
"ubuntu-20.04" | "ubuntu-22.04" | "ubuntu-23.04")
    ...
    sudo apt update && sudo DEBIAN_FRONTEND=noninteractive apt-get install -y  git g++ linux-headers-generic cmake libelf-dev pkg-config kmod |& tee -a "$LOG_FILE"
