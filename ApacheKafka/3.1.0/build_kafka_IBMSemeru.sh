...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ApacheKafka/3.1.0/build_kafka_IBMSemeru.sh
...
SOURCE_ROOT="$(pwd)"
FORCE="false"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ApacheKafka/3.1.0/patch"
