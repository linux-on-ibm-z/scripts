...
PROXY_REPO_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/IstioProxy/1.1.7/build_istio_proxy.sh"
...
function runTest() {
	...
	if [[ "$TESTS" == "true" ]]; then
		...
		sudo chmod +x $GOPATH/bin/envoy
		sudo chmod +x $GOPATH/out/linux_s390x/release/envoy
