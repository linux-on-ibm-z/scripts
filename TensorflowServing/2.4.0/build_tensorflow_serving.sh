...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/TensorflowServing/2.4.0/build_tensorflow_serving.sh
...
function configureAndInstall() {
        ...
        sudo pip3 install /tmp/tensorflow_wheel/tensorflow-2.4.0-cp*-linux_s390x.whl
        ...
        #Apply Patches
        export PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/TensorflowServing/2.4.0/patch"
        ...
        sudo pip3 install tensorflow-serving-api==2.4.0
