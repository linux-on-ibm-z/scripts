...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/librdkafka/2.6.1/build_librdkafka.sh
...
"sles-15.6")
	...
	if [ $ID$VERSION_ID == sles15.5 ]; then
...
"ubuntu-20.04" | "ubuntu-22.04" | "ubuntu-24.04" | "ubuntu-24.10")
	...
	if [ $ID$VERSION_ID == ubuntu20.04 ]; then
