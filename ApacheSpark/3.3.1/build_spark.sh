...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ApacheSpark/3.3.1/build_spark.sh
...
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ApacheSpark/3.3.1/patch/spark.diff"
...
# JDK 17 URL
JDK17_URL="https://github.com/adoptium/temurin17-binaries/releases/download/jdk-17.0.6%2B10/OpenJDK17U-jdk_s390x_linux_hotspot_17.0.6_10.tar.gz"
...
function configureAndInstall() {
    ...
    if [[ "$JAVA_PROVIDED" == "Temurin11" ]]; then
        ...
        if [[ "${ID}" == "ubuntu" ]]; then
            ...
            sudo zypper install -y java-17-openjdk-devel-17.0.4.0-150400.3.3.1 java-17-openjdk-devel-17.0.4.0-150400.3.3.1
