...
#Description:   The script builds Prow (commits till 28-Feb-2023) on Linux on IBM Z for RHEL (7.8, 7.9, 8.4, 8.6, 8.7, 9.0, 9.1), Ubuntu (18.04, 20.04, 22.04, 22.10) and SLES (12 SP5, 15 SP4).
