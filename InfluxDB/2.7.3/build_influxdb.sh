...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/InfluxDB/2.7.3/build_influxdb.sh
...
function cleanup() {
	if [[ ${DISTRO} == "sles-12.5" ]]; then
		...
		sudo rm -rf ${CURDIR}/cmake-3.27.7 ${CURDIR}/cmake-3.27.7.tar.gz 
	fi
