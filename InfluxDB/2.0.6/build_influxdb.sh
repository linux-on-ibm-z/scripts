...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/InfluxDB/2.0.6/build_influxdb.sh
...
GO_INSTALL_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Go/1.16.3/build_go.sh"
...
function cleanup() {
	...
	if [[ -f ${CURDIR}/go1.16.3.linux-s390x.tar.gz ]]; then
		sudo rm ${CURDIR}/go1.16.3.linux-s390x.tar.gz
	fi
