...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/InfluxDB/2.0.3/build_influxdb.sh
...
function cleanup() {
	...
	if [[ -f ${CURDIR}/go1.15.6.linux-s390x.tar.gz ]]; then
		sudo rm ${CURDIR}/go1.15.6.linux-s390x.tar.gz
	fi
