...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/InfluxDB/2.4.0/build_influxdb.sh
...
function gettingStarted() {
    ...
    printf -- "\nMore information can be found here: https://docs.influxdata.com/influxdb/v2.2/get-started\n"
    printf -- '\n\n**********************************************************************************************************\n'
}
