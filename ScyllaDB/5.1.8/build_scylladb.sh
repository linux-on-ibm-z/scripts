...
#
# Instructions:
# Download build script: wget -q https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ScyllaDB/5.1.8/build_scylladb.sh
...
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ScyllaDB/5.1.8/patch"
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  sudo yum install -y java-1.8.0-openjdk-devel libaio-devel systemtap-sdt-devel lksctp-tools-devel \
    xfsprogs-devel snappy-devel libyaml-devel openssl-devel libevent-devel libtasn1-devel libmpcdec \
    ...
    systemd-devel valgrind-devel net-tools langpacks-en glibc-all-langpacks |& tee -a "$LOG_FILE"
