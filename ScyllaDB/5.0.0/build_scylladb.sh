...
#
# Instructions:
# Download build script: wget -q https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ScyllaDB/5.0.0/build_scylladb.sh
...
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/ScyllaDB/5.0.0/patch"
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  sudo yum install -y gcc gcc-c++ gcc-toolset-11 gcc-toolset-11-libatomic-devel \
  ...
  cmake clang hwloc hwloc-devel xxhash xxhash-devel  cryptopp \
  cryptopp-devel lz4 lz4-devel jsoncpp jsoncpp-devel \
  protobuf rapidjson-devel stow fmt fmt-devel \
  yaml-cpp yaml-cpp-devel |& tee -a "$LOG_FILE"
