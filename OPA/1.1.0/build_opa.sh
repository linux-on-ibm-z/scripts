...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/OPA/1.1.0/build_opa.sh
...
GO_VERSION="1.23.5" # see https://github.com/open-policy-agent/opa/blob/v1.1.0/.go-version
SOURCE_ROOT="$(pwd)"
...
function configureAndInstall() {
    ...
    cd $SOURCE_ROOT
    export GOLANGCI_VERSION=v1.60.1
    git clone -b $GOLANGCI_VERSION https://github.com/golangci/golangci-lint.git
    cd golangci-lint/
    ./install.sh $GOLANGCI_VERSION
    cd bin
    docker build -t golangci/golangci-lint:v1.60.1 -f ../build/buildx.Dockerfile .
