...
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/OPA/1.20.0/build_opa.sh
...
GO_VERSION="1.27.0" # see https://github.com/open-policy-agent/opa/blob/v1.20.0/.go-version
SOURCE_ROOT="$(pwd)"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/OPA/1.20.0/patch"
...
function configureAndInstall() {
    ...
    make image-s390x
    printf -- "OPA docker image build completed successfully. \n"
