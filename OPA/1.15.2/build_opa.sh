...
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/OPA/1.15.2/build_opa.sh
...
GO_VERSION="1.26.2" # see https://github.com/open-policy-agent/opa/blob/v1.15.2/.go-version
SOURCE_ROOT="$(pwd)"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/OPA/1.15.2/patch"
