...
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/OPA/1.17.1/build_opa.sh
...
GO_VERSION="1.26.3" # see https://github.com/open-policy-agent/opa/blob/v1.17.1/.go-version
SOURCE_ROOT="$(pwd)"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/OPA/1.17.1/patch"
...
function configureAndInstall() {
    ...
    wget -q https://github.com/bytecodealliance/wasmtime/releases/download/v44.0.0/wasmtime-v44.0.0-s390x-linux-c-api.tar.xz
    tar xf wasmtime-v44.0.0-s390x-linux-c-api.tar.xz
    sudo cp wasmtime-v44.0.0-s390x-linux-c-api/lib/libwasmtime.a /usr/lib
    sudo cp -r wasmtime-v44.0.0-s390x-linux-c-api/include/* /usr/include/
