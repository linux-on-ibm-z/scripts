...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/OPA/1.7.1/build_opa.sh
...
GO_VERSION="1.24.4" # see https://github.com/open-policy-agent/opa/blob/v1.7.1/.go-version
SOURCE_ROOT="$(pwd)"
