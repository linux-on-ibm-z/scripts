...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/OPA/0.62.1/build_opa.sh
...
GO_VERSION="1.22.1" # see https://github.com/open-policy-agent/opa/blob/v0.62.1/.go-version
SOURCE_ROOT="$(pwd)"
...
function gettingStarted() {
    ...
    printf -- " Binary is available in $SOURCE_ROOT/opa/_release/0.62.1/opa_linux_s390x \n"
    printf -- '**********************************************************************************************************\n'
}
