...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/OPA/0.64.1/build_opa.sh
...
GO_VERSION="1.22.2" # see https://github.com/open-policy-agent/opa/blob/v0.64.1/.go-version
SOURCE_ROOT="$(pwd)"
