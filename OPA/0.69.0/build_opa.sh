...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/OPA/0.69.0/build_opa.sh
...
GO_VERSION="1.23.1" # see https://github.com/open-policy-agent/opa/blob/v0.69.0/.go-version
SOURCE_ROOT="$(pwd)"
...
function configureAndInstall() {
    ...
    #Build OPA
    if [[ $DISTRO == "rhel-9.2" || $DISTRO == "rhel-9.4" || $DISTRO == "ubuntu-22.04" || $DISTRO == "ubuntu-24.04" ]]; then
...
function gettingStarted() {
    ...
    printf -- " Binary is available in $SOURCE_ROOT/opa/_release/0.69.0/opa_linux_s390x \n"
    printf -- '**********************************************************************************************************\n'
}
