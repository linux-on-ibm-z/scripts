...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/OPA/0.68.0/build_opa.sh
...
GO_VERSION="1.22.5" # see https://github.com/open-policy-agent/opa/blob/v0.68.0/.go-version
SOURCE_ROOT="$(pwd)"
...
function gettingStarted() {
    ...
    printf -- " Binary is available in $SOURCE_ROOT/opa/_release/0.68.0/opa_linux_s390x \n"
    printf -- '**********************************************************************************************************\n'
}
