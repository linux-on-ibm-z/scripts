...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/OPA/0.70.0/build_opa.sh
...
GO_VERSION="1.23.1" # see https://github.com/open-policy-agent/opa/blob/v0.70.0/.go-version
SOURCE_ROOT="$(pwd)"
