...
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/OPA/1.18.2/build_opa.sh
...
GO_VERSION="1.26.4" # see https://github.com/open-policy-agent/opa/blob/v1.18.2/.go-version
SOURCE_ROOT="$(pwd)"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/OPA/1.18.2/patch"
...
function configureAndInstall() {
    ...
    wget https://github.com/bytecodealliance/wasmtime/releases/download/v44.0.0/wasmtime-v44.0.0-s390x-linux-c-api.tar.xz
