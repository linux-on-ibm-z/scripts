...
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/OPA/1.11.0/build_opa.sh
...
GO_VERSION="1.25.4" # see https://github.com/open-policy-agent/opa/blob/v1.11.0/.go-version
SOURCE_ROOT="$(pwd)"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/OPA/1.11.0/patch"
