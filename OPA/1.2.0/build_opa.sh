...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/OPA/1.2.0/build_opa.sh
...
GO_VERSION="1.24.0" # see https://github.com/open-policy-agent/opa/blob/v1.2.0/.go-version
SOURCE_ROOT="$(pwd)"
