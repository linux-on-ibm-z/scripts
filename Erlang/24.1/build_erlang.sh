...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Erlang/24.1/build_erlang.sh
...
function configureAndInstall() {
    ...
    if [[ "$JAVA_PROVIDED" == "IBM_Semeru_11" ]]; then
        ...
        sudo tar -C /opt/java -xzf ibm-semeru-open-jdk_s390x_linux_11.0.12_7_openj9-0.27.0.tar.gz --strip 1
        ...
        sudo tar -C /opt/java -xzf OpenJDK11U-jdk_s390x_linux_hotspot_11.0.12_7.tar.gz --strip 1
        export JAVA_HOME=/opt/java
